  ...
  methods: {
          ...
          Object.assign(
              {
                ...
                extendOperateBtns: [
                  {
                    ...
                    click: () => {
                      Message.success('点击了test按钮');
                    },
                    activeClick: () => {
                      Message.success('点击了test按钮 active状态')
                    },
                  },
                ],
                isFlv: this.isFlv,
                ...
                contextmenuBtns: [
                  ...
                  },
                  {
                    ...
                    index: 2,
                    click: () => {
                      Message.success('如需要购买PRO版本可以联系添加作者微信：bosswancheng');
                    }
                  }
                ],
    ...
    play() {
      ...
      if (this.playUrl) {
        ...
        Message.error('play url is empty')
      ...
      if (this.jessibuca.isPlaybackPause()) {
        ...
        if (this.playUrl) {
          this.jessibuca.playback(this.playUrl, {
            ...
            Message.success('playback success');
          }).catch((e) => {
            Message.error(`playback error : ${toString(e)}`);
          })
